...
public class ChatService {
  ...
  public String processChat(String sessionId, String userInput, String apiKey) {
    ...
    if (!sessionStorage.containsKey(sessionId)) {
      ...
      initialPrompt.put("content", "You are a friendly Korean teacher who guides foreign friends. "
          + "The topic is '" + userInput + "'. "
          + "If I speak awkwardly or use the wrong words, please correct me. "
          + "If there is nothing to fix, please continue the conversation. "
          + "If corrections are needed, please provide the corrected sentence along with an English translation and a Korean pronunciation that can be read in English. "
